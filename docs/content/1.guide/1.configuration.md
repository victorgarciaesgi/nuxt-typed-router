---
title: Configuration
description: Configure Nuxt Typed Router options
navigation:
...
Add a `nuxtTypedRouter` section in your `nuxt.config`:
...
See [How it works](/usage/how-to-use) for documentation on how to use the typed router.

::note
If you disabled auto-imports, you can see the [usage without auto-imports](/api/import-aliases).
::
