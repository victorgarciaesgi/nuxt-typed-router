---
title: Helpers
description: Use helper utilities for typed route objects
navigation:
...
It will give you autocomplete and type check for route objects:
...
It will give you autocomplete and type check for string paths:
