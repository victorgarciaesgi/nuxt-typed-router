---
title: useRoute()
description: Use the typed useRoute composable
navigation:
  icon: i-lucide-route
---
...
But if you have a `[foo]-[[bar]].vue` page file, the `bar` param will be correctly inferred as optional in the `route` object:
...
For example, if you're editing `pages/profile/[id].vue`, you can directly do this and save time.
