---
title: useRouter()
description: Use the typed useRouter composable
navigation:
...
If you have a `[foo]-[[bar]].vue` page file, the `bar` param will be correctly inferred as optional in the `params` option:
