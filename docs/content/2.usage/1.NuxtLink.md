---
title: <NuxtLink/>
description: Use typed NuxtLink component for safe navigation
navigation:
  icon: i-lucide-link
---
...
Your IDE will throw an error if the route `name` does not exist or if the `params` are invalid.
